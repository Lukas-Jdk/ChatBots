export const home = {
  ...
  why1: { title: "24/7 Availability", text: "Always ready to assist your visitors." },
  why2: { title: "Increase Efficiency", text: "Reduce workload & speed up responses." },
  why3: { title: "Boost Your Sales", text: "Capture more potential customers." },
